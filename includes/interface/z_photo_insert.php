...
//			,	'digits'	=>	12
	...
	// YEAH, BITCH!
	$story_row['photo_title'] = htmlentities
	(	preg_replace
		(	'/[ \t\n\r]+/'
		,	' '
		,	preg_replace
	...
	while
		(	!$GLOBALS['dbi']->insert_row
			(	array
				(	'table'	=>	'owned'
				,	'row'	=>	array
					(	'ownership_id'	=>	$GLOBALS['dbi']->tables['story_photo']->owners['story_teller']
...
//						,	'photo_link'			=>	'//youtube.com/watch?v='
//							.	$submission_row['photo_code']
				)
			)
		);
	endif;
